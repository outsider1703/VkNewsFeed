...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    private func helpInFourthLayer(view: UIView, imageView: UIImageView, label: UILabel) {
        ...
        imageView.widthAnchor.constraint(equalToConstant: Constants.bottomViewViewIconSize).isActive = true
        imageView.heightAnchor.constraint(equalToConstant: Constants.bottomViewViewIconSize).isActive = true
